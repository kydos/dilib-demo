#ifndef SQMESSAGEDCPS_IMPL_H_
#define SQMESSAGEDCPS_IMPL_H_
...
namespace dilib {
    ...
    namespace demo {
        ...
        class  MessageTypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
        {
        public:
...
#define SQMESSAGE_DCPS_TYPESUPPORT_DEFINED
#undef OS_API
#endif
